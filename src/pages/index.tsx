...
const Profile = () => {
  return <Container maxWidth="xl" sx={{ pb: 2 }}>
    ...
    >
      ...
      曾以<Artist name="岡崎律子">森野律</Artist>等名义创作广告音乐，并为众多动画、游戏及歌手提供作品。
      <br />
      1993年正式以唱作歌手身份出道。此后与<Artist>林原めぐみ</Artist>、<Artist>飯塚雅弓</Artist>、<Artist>井上喜久子</Artist>、<Artist>堀江由衣</Artist>、<Artist>小森まなみ</Artist>等众多歌手及声优合作，
      创作领域涵盖动画、游戏及个人音乐的大量作品。
      她的音乐旋律温柔细腻，歌词富有诗意与真挚的情感。
      <br />
      2001年，她为动画《水果篮子》创作并演唱最广为流传的片头曲<Song>For フルーツバスケット</Song>，
      此后又与日向めぐみ组成音乐组合<Artist>メロキュア</Artist>。
      <br />
      在游戏音乐方面，她参与了音乐恋爱游戏<Record name="sr-rainbow">交响乐之雨</Record>的整体音乐创作，
      负责作曲、作词及主题曲演唱等工作，这也是她生前最后完整参与的游戏音乐项目。
      <br />
      2003年被诊断患有胃癌，仍坚持音乐创作，翌年因败血症性休克去世，享年44岁。
      <br />
      2019年，<Song>Agapé</Song>与《残酷な天使のテーゼ》并列获得「平成アニソン大賞」综合大赏。
